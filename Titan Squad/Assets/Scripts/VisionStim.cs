...
public class VisionStim : Item
{
    ...
    {
        StartCoroutine(useVisionStim());
    }

    IEnumerator useVisionStim()
    {
        ...
        mm.startColor = new ParticleSystem.MinMaxGradient(new Color(1f, 142f / 255f, 42f / 255f));
        ...
        shader.SetColor("_OverlayColor", new Color(1f, 142f / 255f, 42f / 255f));
        ...
        target.equippedWeapon.effectiveRange += 2;
        target.equippedWeapon.maxRange += 2;
        ...
        int endTurn = GameManager.instance.turnCount + 2;
